...
test("Date movement validation", async ({ page }) => {
  ...
  await clContractPage.verifyNextDueDate('7/02/2026');
  ...
  await clContractPage.verifyBillsTableTopRowColumnValue('Due Date','31/01/2026');
  await clContractPage.verifyBillsTableTopRowColumnValue('Payment Date','31/01/2026');
  ...
  await clContractPage.verifyLoanPaymentTransactionColumnValue('31/01/2026','Cleared','Checked');
  ...
  await clContractPage.verifyTransactionSummaryBottomRowColumnValue('Transaction Date', '31/01/2026');
  ...
  await transactionSummaryPage.selectEndDate('31/01/2026');
  await transactionSummaryPage.clickHeader();
  await transactionSummaryPage.verifyTopTransactionTypeColumnValue('Repayment','Transaction Date','31/01/2026');
});
